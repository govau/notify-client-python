...
This documentation is for developers interested in using this Python client to integrate their government service with Notify.
...
notifications_client = notify.Client(api_key)
```

Generate an API key by logging in to
[Notify](https://notify.gov.au) and going to
...
| `400`               | `[{`<br>`"error": "BadRequestError",`<br>`"message": "Cannot send letters when service is in trial mode - see https://notify.gov.au/trial-mode"`<br>`}]` |
...
This is an invitation only feature, for more information contact us via[https://notify.gov.au/support](https://notify.gov.au/support).
